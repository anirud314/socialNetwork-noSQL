...
I am writing quick documentation, This program works. I was able to get help from my tutor to fix small bugs related to the api. I dont have time to write a fully detailed document, but the biggest errors I faced with this app is troubleshooting the routes properly and making sure I wrote everything correctly. Here is a gif of me using the app on postman

![LocalHost run](./Assets/nosqlDemo.gif)
